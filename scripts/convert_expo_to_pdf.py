...
body {
    ...
    font-size: 14px; line-height: 2.0; color: #1a1a2e;
...
h3 { font-size: 18px; color: #1d4ed8; margin-top: 28px; }
...
pre { background: #0f172a; color: #e2e8f0; padding: 16px 20px; border-radius: 8px; overflow-x: auto; font-size: 12px; line-height: 1.5; white-space: pre-wrap; word-break: break-all; }
...
td { border: 1px solid #d1d5db; padding: 8px 14px; }
...
md_file = "廊洽会_AgentMatrix宣传视频拍摄方案.md"
pdf_file = "廊洽会_AgentMatrix宣传视频拍摄方案.pdf"
...
temp_html = os.path.join(DOCS_DIR, "_temp_expo.html")
